...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            <!--end::Categories-->
            <!--begin::Brand-->
            <li class="menu-item {{ Request::is('*/admin/brand') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('brand.index', app()->getlocale() ) }}" class="menu-link">
                    <span class="svg-icon menu-icon">
                        <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g id="Stockholm-icons-/-Shopping-/-Price-#1" stroke="none" stroke-width="1" fill="none"
                                fill-rule="evenodd">
