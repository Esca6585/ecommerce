		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('metronic-template/v8/assets/media/illustrations/development-hd.png') }})">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="#" class="mb-12">
						<img alt="Logo" src="{{ asset('metronic-template/v8/assets/media/logos/sumbar-market-logo-2-2.png') }}" class="h-45px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form method="POST" action="{{ route('login', app()->getLocale()) }}" class="form w-100" >
							...
							<div class="text-center">
								...
								<!--end::Separator-->
								<!--begin::Google link-->
								<a href="{{ route('login.google', app()->getlocale()) }}" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
								...
								<!--end::Google link-->
								<!--begin::GitHub link-->
								<a href="{{ route('login.github', app()->getlocale()) }}" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
