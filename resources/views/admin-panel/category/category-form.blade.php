                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="{{ route(Request::segment(4) . '.create', app()->getlocale() ) }}" class="btn btn-primary font-weight-bolder">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div id="kt_datatable_filter" class="dataTables_filter">
                                            <label>
                                                <input type="search" class="form-control form-control-sm" id="datatable_search" placeholder="{{ __('Search') }}" aria-controls="kt_datatable">
                                            </label>
                                        </div>
                                    </div>
