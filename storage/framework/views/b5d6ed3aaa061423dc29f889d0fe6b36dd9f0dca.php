...
<?php echo e(__('Categories')); ?> <?php echo e(__( ucfirst(request()->segment(count(request()->segments()))))); ?>
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                <?php if($brand->id): ?>
                                <form
                                    action="<?php echo e(route(Request::segment(3) . '.update', [ app()->getlocale(), $brand->id ] )); ?>"
                                    method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <?php else: ?>
                                    <form
                                        action="<?php echo e(route(Request::segment(3) . '.store', [ app()->getlocale() ] )); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                                                                ...
                                                                value="<?php echo e($brand->name); ?><?php echo e(request()->segment(count(request()->segments())) == 'create' ? old('name') : ''); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="exampleSelect1"
                                                                ...
                                                                <option value="<?php echo e($parentCategory->id); ?>"
                                                                    <?php echo e($parentCategory->id == $brand->category_id ? 'selected=selected' : ''); ?>>
                                                    ...
                                                    <?php if($brand->images): ?>
                                                    <?php $__currentLoopData = $brand->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit"
                                                title="<?php echo e($brand->id ? __('Edit') : __('Create')); ?>"
                                                class="btn <?php echo e($brand->id ? 'btn-warning' : 'btn-primary'); ?> font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    <?php if($brand->id): ?>
                                                    <span
                                                        class="svg-icon svg-icon-md <?php echo e($brand->id ? 'svg-icon-dark' : ''); ?>">
                                                ...
                                                <span class="<?php echo e($brand->id ? 'text-dark' : ''); ?>">
                                                    <?php echo e($brand->id ? __('Edit') : __('Create')); ?>
...
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/ecommerce/resources/views/admin-panel/brand/brand-form.blade.php ENDPATH**/ ?>