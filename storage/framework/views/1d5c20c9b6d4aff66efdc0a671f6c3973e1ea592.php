...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="index.html" class="brand-logo">
            <img alt="metronic-template/v7/assets/media/logos/logo-light.png" src="<?php echo e(asset('metronic-template/v7/assets/media/logos/logo-light.png')); ?>" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                    ...
                    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?php echo e(__('Dashboard')); ?></h5>
                                <!--end::Page Title-->
                                <!--begin::Actions-->
    ...
    <script src="<?php echo e(asset('metronic-template/v7/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')); ?>"></script>
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="<?php echo e(asset('metronic-template/v7/assets/js/pages/widgets.js')); ?>"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/ecommerce/resources/views/admin-panel/dashboard/dashboard.blade.php ENDPATH**/ ?>