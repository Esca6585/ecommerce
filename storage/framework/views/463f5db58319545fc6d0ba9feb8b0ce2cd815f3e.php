        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo e(Auth::guard('admin')->user()->first_name); ?></span>
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><?php echo e(substr(Auth::guard('admin')->user()->first_name, 0, 1)); ?></span>
                    </span>
                </div>
            </div>
            <!--end::User-->
...
<!--end::Header--><?php /**PATH /home/ubuntu/Documents/domains/sumbar-market/resources/views/layouts/header.blade.php ENDPATH**/ ?>