...
<?php echo e(__('Categories')); ?> <?php echo e(__('View')); ?>
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted"><?php echo e(__('Categories')); ?></a>
                                        </li>
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <div class="row mb-17">
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">
                                                <?php echo e($category->{ 'name_' . app()->getlocale() }); ?></h2>

                                            <h5>
                                                <a href="<?php echo e(route(Request::segment(4) . '.show', [ app()->getlocale(), $categoryType, $category->parent ? $category->parent->id : $category->id ] )); ?>"
                                                    class="<?php echo e($category->parent ? 'text-warning' : 'text-primary'); ?>">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col m-5">
                                            <div class="image-input image-input-outline" id="kt_image_<?php echo e($key); ?>"
                                                data-images-count="" style="background-image: url();">
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    <a href="<?php echo e(url()->previous()); ?>" class="btn btn-sm btn-clean btn-icon mr-2">
                                        <span class="svg-icon svg-icon-xl">
                                    ...
                                    <a href="<?php echo e(route(Request::segment(4) . '.edit', [ app()->getlocale(), $categoryType, $category->id ] )); ?>"
                                        title="<?php echo e(__('Edit')); ?>" class="btn btn-warning font-weight-bolder">
...
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/ecommerce/resources/views/admin-panel/category/category-show.blade.php ENDPATH**/ ?>