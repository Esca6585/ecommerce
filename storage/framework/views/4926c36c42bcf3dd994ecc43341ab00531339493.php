            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active">
                        <a href="<?php echo e(route('admin.dashboard', app()->getlocale() )); ?>" class="menu-link menu-toggle">
        ...
        <div class="topbar">
                    ...
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <?php $__currentLoopData = Config::get('languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(app()->getlocale() == $lang): ?>
                                <img class="h-20px w-20px rounded-sm" src="<?php echo e(asset('metronic-template/v7/assets/media/svg/flags/' . $language['icon'] )); ?>" alt="<?php echo e($language['icon']); ?>"  />
                            <?php endif; ?>
                            <!--end::Item 2-->
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo e(Auth::guard('admin')->user()->name); ?></span>
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><?php echo e(substr(Auth::guard('admin')->user()->name, 0, 1)); ?></span>
                    </span>
                </div>
            </div>
            <!--end::User-->
...
<!--end::Header--><?php /**PATH C:\OpenServer\domains\ecommerce\resources\views/layouts/header.blade.php ENDPATH**/ ?>