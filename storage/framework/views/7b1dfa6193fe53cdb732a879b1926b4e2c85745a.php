                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="<?php echo e(route('allcategory.index', app()->getlocale() )); ?>" class="text-muted"><?php echo e(__('Categories')); ?></a>
                                        </li>
                                        
                                        <li class="breadcrumb-item text-muted">
                                            <a href="<?php echo e(route(Route::currentRouteName(), app()->getlocale() )); ?>" class="text-muted">
                                                <?php if(Request::is('*/admin/category/allcategory*')): ?>
                                                    <?php echo e(__('All Categories')); ?>
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="datatable">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e($category->parent ? route( Request::segment(4) . '.show', [ app()->getlocale(), $category->parent_id ]) : route( Request::segment(4) . '.show', [ app()->getlocale(), $category->id ])); ?>"
