...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="index.html" class="brand-logo">
            <img alt="metronic-template/v7/assets/media/logos/logo-light.png"
                src="<?php echo e(asset('metronic-template/v7/assets/media/logos/logo-light.png')); ?>" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
    ...
    <script src="<?php echo e(asset('metronic-template/v7/assets/js/ajax/jquery.dataTables.min.js')); ?>"></script>
    
    <script src="<?php echo e(asset('metronic-template/v7/assets/plugins/custom/datatables/datatables.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('metronic-template/v7/assets/js/pages/crud/datatables/basic/paginations.js')); ?>"></script>
...
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\ecommerce\resources\views/admin-panel/category/category.blade.php ENDPATH**/ ?>