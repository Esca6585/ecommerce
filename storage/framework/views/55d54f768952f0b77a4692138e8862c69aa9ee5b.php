			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?php echo e(asset('metronic-template/v8/assets/media/illustrations/development-hd.png')); ?>)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form method="POST" action="<?php echo e(route('admin.login', app()->getLocale())); ?>" class="form w-100" >
							<?php echo csrf_field(); ?>
							<!--begin::Heading-->
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									...
									<!--end::Label-->
									<!--begin::Link-->
									<a href="#forgot_password" class="link-primary fs-6 fw-bolder"><?php echo e(__('Forgot Your Password?')); ?></a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/sumbar-market/resources/views/auth/admin-login.blade.php ENDPATH**/ ?>