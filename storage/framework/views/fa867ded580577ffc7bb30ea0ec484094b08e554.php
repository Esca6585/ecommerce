                                    ...
                                    <div class="row mb-17">
                                        <div class="col-xxl-5 mb-11 mb-xxl-0">
                                            ...
                                            <div class="card card-custom card-stretch">
                                                <div class="card-body p-0 rounded px-10 py-15 d-flex align-items-center justify-content-center"
                                                    ...
                                                    <img src="<?php echo e(asset($brand->image)); ?>" class="mw-100 w-200px"
                                        ...
                                        <div class="col-xxl-7 pl-xxl-11">
                                            <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">
                                                <?php echo e($brand->name); ?></h2>

                                            <h5>
                                                <a href="<?php echo e(route('category.show', [ app()->getlocale(), 'all', $brand->category_id ] )); ?>"
                                                    class="text-primary">
                                        ...
                                        <div class="col m-5">
                                            <div class="image-input image-input-outline" id="kt_image_1"
                                                ...
                                                <div class="image-input-wrapper"
                                                    style="background-image: url(<?php echo e(asset($brand->image)); ?>)">
                                                </div>
...
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/ecommerce/resources/views/admin-panel/brand/brand-show.blade.php ENDPATH**/ ?>