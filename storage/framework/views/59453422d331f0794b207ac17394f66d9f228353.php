...
<div class="alert alert-fixed alert-custom alert-light-primary fade show mb-5" id="alert-message" role="alert">
    ...
    <div class="alert-text"><?php echo e(__(session()->get('success-create'))); ?></div>
...
<div class="alert alert-fixed alert-custom alert-light-warning fade show mb-5" id="alert-message" role="alert">
    ...
    <div class="alert-text"><?php echo e(__(session()->get('success-update'))); ?></div>
    <div class="alert-close">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">
                <i class="ki ki-close"></i>
...
<div class="alert alert-fixed alert-custom alert-light-danger fade show mb-5" id="alert-message" role="alert">
    ...
    <div class="alert-text"><?php echo e(__(session()->get('success-delete'))); ?></div>
    <div class="alert-close">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">
                <i class="ki ki-close"></i>
...
<div class="alert alert-fixed alert-custom alert-light-danger fade show mb-5" id="alert-message" role="alert">
    ...
    <div class="alert-text"><?php echo e(__(session()->get('warning'))); ?></div>
    <div class="alert-close">
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">
                <i class="ki ki-close"></i>
...
<?php endif; ?>
<!--end::Alert--><?php /**PATH /home/ubuntu/Documents/domains/sumbar-market/resources/views/layouts/alert.blade.php ENDPATH**/ ?>