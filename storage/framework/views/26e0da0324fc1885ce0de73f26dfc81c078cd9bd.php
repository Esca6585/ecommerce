...
<html lang="<?php echo e(app()->getLocale()); ?>">
	...
	<!--begin::jQuery-->
	<script src="<?php echo e(asset('/metronic-template/v8/assets/js/ajax/jquery-3.6.0.min.js')); ?>"></script>
	<script src="<?php echo e(asset('/metronic-template/v8/assets/js/ajax/changeLanguage.js')); ?>"></script>
    <!--begin::jQuery-->


</html>

<?php /**PATH C:\OpenServer\domains\ecommerce\resources\views/layouts/app.blade.php ENDPATH**/ ?>