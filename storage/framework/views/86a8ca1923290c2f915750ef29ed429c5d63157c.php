                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="<?php echo e(route(Request::segment(3) . '.create', [ app()->getlocale() ] )); ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin: Datatable-->
                                    <?php echo $__env->make('admin-panel.product.product-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <!--end: Datatable-->
                                </div>
                            </div>
                            <!--end::Card-->
...
<?php echo $__env->make('layouts.admin-template-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubuntu/Documents/domains/sumbar-market/resources/views/admin-panel/product/product.blade.php ENDPATH**/ ?>